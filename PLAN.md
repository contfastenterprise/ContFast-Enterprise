...
- **Soporte para Gastos Exentos de ITBIS**: Incorporación de un checkbox "Gasto Exento de ITBIS (No posee ITBIS)" en el formulario de compras. Al activarse, deshabilita y pone en cero el campo de entrada de ITBIS (tanto en desglose general como en líneas de artículos físicas) y asegura de manera reactiva que el Subtotal sea exactamente igual al Monto Total del gasto.
