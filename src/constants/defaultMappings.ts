...
export const DEFAULT_ROUTE_MAPPINGS: RouteMapping[] = [
  ...
  { id: '37b', routePattern: '/dashboard/financial/customer-balances%', module: 'contabilidad', action: 'read', isMenuItem: true, displayName: 'Balance Clientes', groupName: 'Finanzas', iconName: 'Users', orderIndex: 7, createdAt: new Date(), updatedAt: new Date() },
  { id: '38', routePattern: '/dashboard/financial/suppliers%', module: 'contabilidad', action: 'read', isMenuItem: true, displayName: 'E.C. Suplidores (CxP)', groupName: 'Finanzas', iconName: 'Receipt', orderIndex: 8, createdAt: new Date(), updatedAt: new Date() },
  { id: '38b', routePattern: '/dashboard/financial/supplier-balances%', module: 'contabilidad', action: 'read', isMenuItem: true, displayName: 'Balance Suplidores', groupName: 'Finanzas', iconName: 'Truck', orderIndex: 9, createdAt: new Date(), updatedAt: new Date() },
