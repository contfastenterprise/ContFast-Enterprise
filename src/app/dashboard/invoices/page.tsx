      ...
      <AnimatePresence mode="wait">
        {showForm ? (
          ...
          >
            ...
            {/* Legend above table */}
            <div className="flex flex-wrap items-center gap-3 bg-white border border-slate-200 rounded-xl px-4 py-2.5 shadow-md text-xs text-slate-500 mb-4 justify-between">
              <div className="flex flex-wrap items-center gap-2">
                <span className="font-bold text-[#003366]">Leyenda Método de Pago (Método):</span>
                <span className="bg-slate-100 px-2 py-0.5 rounded font-semibold text-slate-700"><span className="text-[#003366] font-bold">E</span> = Efectivo</span>
                <span className="bg-slate-100 px-2 py-0.5 rounded font-semibold text-slate-700"><span className="text-[#003366] font-bold">C</span> = Crédito</span>
                <span className="bg-slate-100 px-2 py-0.5 rounded font-semibold text-slate-700"><span className="text-[#003366] font-bold">T</span> = Transferencia Bancaria</span>
              </div>
            </div>
