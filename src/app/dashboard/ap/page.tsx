                ...
                <form onSubmit={handleSubmitPayment} className="p-6 space-y-4 overflow-y-auto flex-1 text-sm text-slate-300">
                  ...
                  {paymentForm.paymentMethod === 'check' && (
                    ...
                    >
                      ...
                      <div className="border-t border-slate-850 pt-3 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                  ...
                  <div className="bg-slate-950/40 p-4 rounded-xl border border-slate-850 shrink-0 flex items-center justify-between mt-6">
                    ...
                    <button 
                      type="submit" 
                      disabled={submitting} 
                      className="bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold py-2.5 px-6 rounded-lg text-xs shadow-md transition-all flex items-center gap-2 disabled:opacity-50 active:scale-[0.98]"
                    >
