...
export default function AccountsPayableDashboard({ initialData }: { initialData: any }) {
        ...
        <div className="m-0 focus:outline-none">
          ...
          {activeTab === 'calendar' && (
            <div className="bg-surface-bright border border-outline-variant/20 rounded-2xl p-8 text-center text-neutral-500">
              ...
              <h3 className="text-lg font-medium text-neutral-800 dark:text-neutral-200">Calendario Financiero</h3>
              <p className="max-w-md mx-auto mt-2">Visualiza las fechas límite de todos los pagos en un calendario interactivo. (Módulo en construcción)</p>
            </div>
          )}
          {activeTab === 'activity' && (
            <div className="bg-surface-bright border border-outline-variant/20 rounded-2xl p-8 text-center text-neutral-500">
              ...
              <p className="max-w-md mx-auto mt-2">Rastrea cada movimiento, pago programado y conciliación bancaria. (Módulo en construcción)</p>
            </div>
          )}
        </div>
      </div>
